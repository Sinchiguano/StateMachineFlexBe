...
let BehaviorSynthesisGoal = require('./BehaviorSynthesisGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class BehaviorSynthesisActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new BehaviorSynthesisGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = BehaviorSynthesisGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new BehaviorSynthesisActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = BehaviorSynthesisGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += BehaviorSynthesisGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BehaviorSynthesisActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = BehaviorSynthesisGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new BehaviorSynthesisGoal()
    }
...
module.exports = BehaviorSynthesisActionGoal;
